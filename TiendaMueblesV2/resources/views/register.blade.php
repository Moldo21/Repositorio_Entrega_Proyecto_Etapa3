...
<head>
    ...
    <style>
        ...
        .register-container { width: 100%; max-width: 480px; padding: 0 1rem; }
        .register-card { background: #fff; border: 2px solid #000; border-radius: 10px; padding: 2.25rem; box-shadow: 0 4px 15px rgba(0,0,0,0.1); }
        .brand-name { font-size: 1.5rem; font-weight: 700; color: #000; text-decoration: none; }
        .brand-name:hover { color: #333; }
        .register-title { font-size: 1.75rem; font-weight: 700; margin-bottom: 1.25rem; text-align: center; }
        ...
        .btn-register { background: #000; color: #fff; border: 2px solid #000; padding: 0.75rem; border-radius: 8px; font-weight: 600; width: 100%; }
        .btn-register:hover { background: #fff; color: #000; }
        .login-link { text-align: center; margin-top: 1rem; padding-top: 1rem; border-top: 1px solid #ddd; }
        .login-link a { color: #000; font-weight: 600; text-decoration: none; border-bottom: 2px solid #000; }
        ...
        @media (max-width: 576px) { .register-card { padding: 1.5rem; } .register-title { font-size: 1.5rem; } .brand-name { font-size: 1.25rem; } }
    </style>
</head>
